            ...
            <div class="container">
                <div class="row boxer">
                    <div class="col-sm-4">
                      ...
                      <form method="POST" action="CommandServlet?cmd=pronadjikatalog2">
            ...
            if (listaKataloga != null && !listaKataloga.isEmpty()) { %>
                    ...
                    <tbody>
                        ...
                        <a href="CommandServlet?cmd=katalogmain&id=<%=lis.getRedniBrojKataloga()%>">
                            ...
                            <td><a href="CommandServlet?cmd=napravinarudzbenicu&id=<%=lis.getRedniBrojKataloga()%>">
                    <input type="button" name="di1" class="btn btn-group" value="napravi"/>
                                </a></td>
